...
" =============================================================================
" Denis Volchugin .vimrc file
" -----------------------------------------------------------------------------
" heavily inspired by: Miller Medeiros, @factorylabs, @scrooloose, @nvie, @gf3, @bit-theory, ...
" =============================================================================
...
let g:fzf_layout = { 'window': { 'width': 0.6, 'height': 0.6, 'relative': v:false, 'yoffset': 1.0 } }
"
...
let g:fzf_tags_command = 'ctags -R --options="main.ctags"'
...
set tags=tags                           "settings for each project
...
let g:airline_section_z = "\ue0a1:%l/%L Col:%c" " custom line indicator
"
"" Coc Vim stuff
...
let g:ycm_min_num_of_chars_for_completion=1 "list the matches from the second typed character
...
let g:ycm_python_sys_path = ['/usr/local/bin/python3.9']
...
nnoremap <silent> <C-w>0 <C-w><C-_>           " set current window max size
nnoremap <silent> <leader>> 20<C-w><C->>      " increase width of current window
nnoremap <silent> <leader>< 20<C-w><C-><      " decrease width of current window
...
set rtp+=/usr/local/bin/fzf                         "file manager
...
let g:pymode_breakpoint_key = '<leader>bb'
"
...
let g:jedi#completions_command = '<S-S>'
